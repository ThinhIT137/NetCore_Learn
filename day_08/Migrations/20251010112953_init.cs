        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Username = table.Column<string>(type: "nvarchar(54)", maxLength: 54, nullable: false),
                    Password = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    FullName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Picture = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    ...
                    Phone = table.Column<string>(type: "nvarchar(54)", maxLength: 54, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: false),
                    ReceiveAddress = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    ReceivePhone = table.Column<string>(type: "nvarchar(54)", maxLength: 54, nullable: false),
                    OrderEffective = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderBooks_Accounts_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderDetails_OrderBooks_OrderId",
                        column: x => x.OrderId,
